...
- Review 37 redacted secret-pattern finding(s) from the audit index before publishing or deploying.
...
- Redacted audit has 37 possible secret-pattern finding(s); manually review before publication or deploy.
