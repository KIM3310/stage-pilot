...
AI SDK tool-calling middleware with multi-agent orchestration and benchmark harness
...
| Area | Position |
| --- | --- |
| Target reviewer | AI platform teams shipping tool-calling agents |
| Service wedge | Developer package, support plan, and reliability audit |
| Review signal | Runtime reliability, parser recovery, benchmark discipline |
