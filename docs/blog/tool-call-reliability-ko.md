...
> **과거 벤치마크 안내 (2026-08-12 갱신):** 이 글은 기존의 결정론적 40개 케이스·20개 변형 벤치마크(25% → 90%)를 설명합니다. 현재 체크인된 실행기와 [최신 보고서](../benchmarks/stagepilot-latest.json)는 60개 케이스·30개 변형을 다루며, 같은 전략의 결과는 33.3%, 66.7%, 90.0%입니다. 이는 파서 복구용 픽스처 결과이며 일반적인 모델 품질 수치가 아닙니다.
...
**Doeon Kim**은 검증 가능한 AI 시스템, 도구 호출 신뢰성 런타임, 운영 워크플로를 개발합니다. Microsoft AI School을 수료했으며 IT 인프라 운영 경험이 있습니다.
