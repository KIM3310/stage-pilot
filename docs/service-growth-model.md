# Service Growth Model - stage-pilot
...
| Field | Decision |
|---|---|
| Service type | Agent runtime reliability |
| Primary reader or buyer | AI engineering teams shipping tool-calling agents. |
| Wedge | Reliability audit using buyer-provided failure traces or synthetic fixtures. |
