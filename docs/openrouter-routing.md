...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `qwen/qwen3-coder` | Tool-call benchmark routing, RALPH prompt comparisons, and provider scorecards. |
...
OPENROUTER_HTTP_REFERER=https://stage-pilot.pages.dev
OPENROUTER_APP_TITLE=stage-pilot
```
